...
public class CreatGroupFile extends Thread{
    Socket server;
    ...
    public CreatGroupFile(JFrame filejm,Box zbox,String qunid,JLabel jb){
        this.filejm=filejm;
        this.zbox=zbox;
        this.qunid=qunid;
        this.jb=jb;
    ...
    public void run(){
        try {
            ...
            putinfjh.setFunction("Get_group_file");
            ...
            while (true){
                ...
                if (state.equals("1")){
                    ...
                    GroupFile groupFile=new GroupFile(filejm,zbox,filename,number,path,jb);
                    groupFile.start();
                }
                if (state.equals("2")){
                    closeSocket();
...
class GroupFile extends Thread{
    int k=0;
    Socket server;
    ObjectOutputStream obputFW;
    ObjectInputStream obgetFW;
    ...
    public GroupFile(JFrame filejm,Box zbox,String filename,String number,String path,JLabel jb){
        this.filejm=filejm;
        this.zbox=zbox;
        ...
        namebut.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (k==0){
                    ...
                    if (jb.getText().equals("1")||jb.getText().equals("2"))
                    zxbox.add(deletbut);
                    k=1;
                }else if (k==1){
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    if (filepath!=null){
                        ...
                        InforMationSet putinfjh=new InforMationSet();
                        putinfjh.setFunction("Receive_group_file");
        ...
        deletbut.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    InforMationSet putinfjh=new InforMationSet();
                    putinfjh.setFunction("Delet_group_file");
                    putinfjh.setAccount(number);
                    putinfjh.setAvatarState(path);
